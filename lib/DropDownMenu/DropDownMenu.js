...
var DropDownMenu = _react2.default.createClass({
  ...
  _setSelectedIndex: function _setSelectedIndex(index) {
    "production" !== "production" ? (0, _warning2.default)(index >= 0, 'Cannot set selectedIndex to a negative index.') : undefined;
  ...
  render: function render() {
    ...
    if (menuItems && typeof selectedIndex === 'number') {
      "production" !== "production" ? (0, _warning2.default)(menuItems[selectedIndex], 'SelectedIndex of ' + selectedIndex + ' does not exist in menuItems.') : undefined;
    }
