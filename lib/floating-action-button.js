...
var FloatingActionButton = _react2.default.createClass({
  ...
  componentDidMount: function componentDidMount() {
    "production" !== "production" ? (0, _warning2.default)(!this.props.iconClassName || !this.props.children, 'You have set both an iconClassName and a child icon. ' + 'It is recommended you use only one method when adding ' + 'icons to FloatingActionButtons.') : undefined;
  },
