...
var AutoComplete = _react2.default.createClass({
  ...
  setValue: function setValue(textValue) {
    "production" !== "production" ? (0, _warning2.default)(false, 'setValue() is deprecated, use the searchText property.') : undefined;
  ...
  getValue: function getValue() {
    "production" !== "production" ? (0, _warning2.default)(false, 'getValue() is deprecated.') : undefined;
