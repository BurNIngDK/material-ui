...
var TimePicker = _react2.default.createClass({
  ...
  getTime: function getTime() {
    "production" !== "production" ? (0, _warning2.default)(false, 'getTime() method is deprecated. Use the defaultTime property\n    instead. Or use the TimePicker as a controlled component with the value\n    property.') : undefined;
  ...
  setTime: function setTime(time) {
    "production" !== "production" ? (0, _warning2.default)(false, 'setTime() method is deprecated. Use the defaultTime property\n    instead. Or use the TimePicker as a controlled component with the value\n    property.') : undefined;
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['autoOk', 'format', 'onFocus', 'onTouchTap', 'onShow', 'onDismiss', 'style', 'textFieldStyle', 'pedantic']);
